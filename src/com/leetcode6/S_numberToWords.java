...
public class S_numberToWords {
	...
	public static void main(String[] args) {
		System.out.println(new S_numberToWords().numberToWords(203010));
		System.out.println(new S_numberToWords().numberToWords(1002323010));
	}
}
